...
const LatestJobs = () => {
    ...
    const jobs_data = [
        ...
        {
          companyLogo: <svg id="I0:2037;51:1462;278:9075" layer-name="Company Logo" width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[64px] h-[64px]"> <g clip-path="url(#clip0_1_2814)"> <path fill-rule="evenodd" clip-rule="evenodd" d="M15.2 52.9201L32.3931 57.5998L32.4132 18.9131L15.2202 14.2334L15.2 52.9201Z" fill="#FF6550"></path> <path fill-rule="evenodd" clip-rule="evenodd" d="M43.6703 11.7247L24.1089 6.3999V13.445L35.4265 16.5273L35.4164 43.3356L43.6602 45.5781C46.4921 46.3461 48.7899 44.206 48.8 40.7961L48.8101 19.3125C48.8 15.8924 46.5022 12.5029 43.6703 11.7247" fill="#FF6550"></path> </g> <defs> <clipPath id="clip0_1_2814"> <rect width="33.6" height="51.2" fill="white" transform="translate(15.2 6.3999)"></rect> </clipPath> </defs> </svg>,
          title: "HR Manager",
          company: "Packer",
